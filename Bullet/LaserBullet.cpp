...
LaserBullet::LaserBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret *parent) : Bullet("play/bullet-2.png", 650, 4, position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
}
